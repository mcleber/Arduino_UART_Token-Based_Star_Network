...
//   RX pino 2 <- TX pino 3 do CENTRAL
//   TX pino 3 -> RX pino 2 do CENTRAL
...
// ============================================================
const char MEU_NOME[]    = "NORTE";
const char MEU_DESTINO[] = "SUL"; // Destinos validos: SUL, LESTE, OESTE, CENTRAL
...
int totalPacotes = 3; // Deve ser igual ao numero de entradas em payloads[]
// ============================================================
