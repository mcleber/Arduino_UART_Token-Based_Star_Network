...
//   RX pino 2 <- TX pino 9 do CENTRAL
//   TX pino 3 -> RX pino 8 do CENTRAL
...
// ============================================================
const char MEU_NOME[]    = "OESTE";
const char MEU_DESTINO[] = "NORTE"; // Destinos validos: NORTE, SUL, LESTE, CENTRAL
...
int totalPacotes = 4; // Deve ser igual ao numero de entradas em payloads[]
// ============================================================
