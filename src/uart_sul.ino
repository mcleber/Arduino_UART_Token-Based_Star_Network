...
//   RX pino 2 <- TX pino 5 do CENTRAL
//   TX pino 3 -> RX pino 4 do CENTRAL
...
// ============================================================
const char MEU_NOME[]    = "SUL";
const char MEU_DESTINO[] = "LESTE"; // Destinos validos: NORTE, LESTE, OESTE, CENTRAL
...
int totalPacotes = 5; // Deve ser igual ao numero de entradas em payloads[]
// ============================================================
